...
export function githubApiBaseUrl(target = {}) {
  let url = String(target.github?.apiBaseUrl || process.env.PR_SHEPHERD_GITHUB_API_URL || DEFAULT_GITHUB_API_BASE_URL);
  // Trailing-slash strip without `/\/+$/` (CodeQL js/polynomial-redos).
