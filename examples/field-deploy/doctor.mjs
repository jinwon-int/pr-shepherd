...
function packageDoctor() {
  ...
  if (phaseJSupervisedRehearsalQueue) {
    ...
    check(/must not run live `repair`|never runs live `repair`/i.test(phaseJSupervisedRehearsalQueue), errors, 'Phase J runbook must block live repair during queueing');
